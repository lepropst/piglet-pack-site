...
export const WelcomeMessage = forwardRef((props, ref) => {
        ...
        <Slide timeout={500} direction="right" in={fadeIn}>
          ...
          >
            <Typography variant="h5">
              <Tab />
              Piglet pack provides essential english and technological services.
              Our expertise allow us to offer well defiined services, as well as
              assess independent and unique situations to advise or act on what
        ...
        <Slide timeout={1500} direction="right" in={fadeIn}>
          ...
          >
            <Typography variant="h5">
              ...
              specialties. We are also able to masnage, advise upon, and deploy
              third party or custom services including serverless or SaaS
              platform services.
            </Typography>
          </Paper>
        </Slide>
